...
namespace TasksCoordinator.Test
{
    ...
    {
        public static ITaskCoordinator CreateTaskCoordinator(BlockingCollection<Message> MessageQueue, ConcurrentBag<Message> ProcessedMessages, int maxReaders= 4, TaskWorkType workType = TaskWorkType.LongCPUBound)
        {
